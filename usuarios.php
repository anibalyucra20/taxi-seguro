                                ...
                                <div class="x_content">
                                  ...
                                  <form role="form" action="operaciones/registrar_empresa.php" class="form-horizontal form-label-left input_mask" method="POST" enctype="multipart/form-data">
                                    <div class="form-group">
                                      <label>DNI</label>
                                      <input type="number" class="form-control" required name="dni">
                                    </div>
                                    <div class="form-group">
                                      <label>Apellidos y Nombres</label>
                                      <input type="text" class="form-control" required name="ap_nom">
                                    </div>
                                    <div class="form-group">
                                      <label>Correo</label>
                                    ...
                                    <div class="form-group">
                                      <label>Nro de Licencia de Conducir</label>
                                      <input type="text" class="form-control" name="nro_licencia" required>
                                    </div>
                                    <div class="form-group">
                                      <label>Fecha de Vencimiento de Licencia de Conducir</label>
                                      <input type="date" class="form-control" required name="fecha_licencia">
                                    </div>
