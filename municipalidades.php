                        ...
                        <div class="modal-dialog modal-lg">
                          <div class="modal-content">
                            ...
                            <div class="modal-header">
                              ...
                              <h4 class="modal-title" id="myModalLabel" align="center">Registrar Municipalidad</h4>
                            </div>
                            <div class="modal-body">
                              ...
                              <div class="x_panel">
                                ...
                                <div class="x_content">
                                  <br />
                                  <form role="form" action="operaciones/registrar_municipalidad.php" class="form-horizontal form-label-left input_mask" method="POST" enctype="multipart/form-data">
                                    <div class="form-group">
                                      <label>Ruc</label>
                                      <input type="number" class="form-control" required name="ruc">
                                    </div>
                                    <div class="form-group">
                                      <label>Nombre Corto</label>
                                      <input type="text" class="form-control" required name="nombre_corto">
                                    </div>
                                    <div class="form-group">
                                      <label>Nombre Completo</label>
                                      <input type="text" class="form-control" required name="nombre_largo">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" required name="link_pagina">
                                    </div>
                                    <div class="form-group">
                                      <label>Logo</label>
                                    ...
                                    <div class="form-group">
                                      <label>Favicon</label>
                                      <input type="file" class="form-control" required name="favicon">
                                    </div>
                                    <div class="form-group">
                                      <label>Host Email</label>
                                      <input type="text" class="form-control" required name="host_mail">
                                    </div>
                                    <div class="form-group">
                                      <label>Correo para envios de Email</label>
                                      <input type="text" class="form-control" required name="email_mail">
                                    </div>
                                    <div class="form-group">
                                      <label>Contraseña para Mail</label>
                                      <input type="text" class="form-control" required name="password_mail">
                                    </div>
                                    <div class="form-group">
                                      <label>Puerto de Envío de Mail</label>
                                      <input type="text" class="form-control" required name="puerto_mail">
                                    </div>
                                    <div class="form-group">
                                      <label>Color del Mail</label>
                                      <input type="color" class="form-control" required name="color_mail">
                                    </div>
