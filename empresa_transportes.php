...
<head>
    ...
    <title>Empresas de Transportes</title>
    <!--icono en el titulo-->
                                                ...
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-header">
                                                            ...
                                                            <h4 class="modal-title" id="myModalLabel" align="center">Registrar Empresa de Transporte</h4>
                                                        </div>
                                                                ...
                                                                <div class="x_content">
                                                                    ...
                                                                    <form role="form" action="operaciones/registrar_empresa.php" class="form-horizontal form-label-left input_mask" method="POST" enctype="multipart/form-data">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control" required name="representante">
                                                                        </div>
                                                                        <div class="form-group">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label>Nro de Resolución de Autorización</label>
                                                                            <input type="text" class="form-control" required name="resolucion">
                                                                        </div>
